...
CREATE TABLE IF NOT EXISTS portfolio_measurement_v1 (
    ...
    percent_return NUMERIC(12, 11) NOT NULL CHECK (percent_return <= 1.0 AND percent_return >= 0.0),
    ...
    total_deposited_to_date NUMERIC(14, 4) NOT NULL CHECK (risk_free_value >= 0.0),
    total_withdrawn_to_date NUMERIC(14, 4) NOT NULL CHECK (risk_free_value <= 0.0),
    user_id VARCHAR(63) NOT NULL DEFAULT current_user,
    value NUMERIC(14, 4) NOT NULL CHECK (risk_free_value >= 0.0),
